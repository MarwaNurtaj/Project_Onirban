                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3 {{ $errors->has('password') ? ' has-error' : '' }}">
                        <label class="col-sm-3 col-form-label col_form_label">Password<span
                                class="req_star">*</span>:</label>
                        <div class="col-sm-7">
                            <input type="password" class="form-control form_control" id="myInput" name="password">
                    ...
                    <div class="row mb-3 {{ $errors->has('cpassword') ? ' has-error' : '' }}">
                        <label class="col-sm-3 col-form-label col_form_label">Confirm-Password<span
                                class="req_star">*</span>:</label>
                        <div class="col-sm-7">
                            <input type="password" class="form-control form_control" id="myInput2" name="cpassword">
                            <input type="checkbox" onclick="myCpFunction()"> Show Password
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label col_form_label">User Status<span
                                class="req_star">*</span>:</label>
                        <div class="col-sm-4">
                            <input type="number" class="form-control form_control " readonly id="" name="user_status"
                                value="1">
                        </div>
                    </div>
