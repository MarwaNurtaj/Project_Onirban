...
<section class="m-5">
    <div class="row">
        <div class="col-md-12 ">
            <form method="POST" action="{{url('website/home/profile/update')}}" enctype="multipart/form-data">
                @csrf
                <div class="card mb-3">
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-8 card_title_part">
                                <i class="fab fa-gg-circle"></i>Edit Your profile
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3 {{ $errors->has('pic') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-2">
                                ...
                                @else
                                <img src="{{ asset('contents/admin/images/avatar.png') }}" style="height:100; "
                                    alt="Profile Picture">
                                @endif
                            </div>
                        </div>
